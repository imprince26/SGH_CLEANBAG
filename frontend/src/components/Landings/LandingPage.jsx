...
function CleanbageApp() {
  ...
  const stats = [
    { value: "95%", label: "Collection Rate", icon: <BarChart3 className="h-5 w-5" /> },
    { value: "500+", label: "Active Bins", icon: <Trash2 className="h-5 w-5" /> },
    { value: "5000+", label: "Happy Users", icon: <Users className="h-5 w-5" /> }
  ];
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-emerald-50 to-white">
      {isAuthenticated ? (
        ...
        <div className="min-h-screen mt-16 py-16 px-4">
          <motion.div
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-emerald-100">
              ...
              <motion.button
                ...
                className="px-8 py-4 bg-emerald-600 text-white rounded-lg font-semibold 
                  hover:bg-emerald-500 transition-all flex items-center gap-2 mx-auto
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
              {stats.map((stat, index) => (
                ...
                >
                  ...
                  <h3 className="text-2xl font-bold text-emerald-800">{stat.value}</h3>
          ...
          <div className="relative container mx-auto px-4 py-16 lg:py-24">
            <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
              ...
              <motion.div
                ...
                className="bg-white p-8 rounded-2xl shadow-lg border border-emerald-100"
              >
                <h1 className="text-4xl lg:text-5xl font-bold text-emerald-800 mb-6 leading-tight">
                  Smart Waste Management for a
                  <span className="text-emerald-600"> Cleaner Tomorrow</span>
                </h1>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <motion.button
                    ...
                    className="px-8 py-4 bg-emerald-600 text-white rounded-lg font-semibold 
                      hover:bg-emerald-500 transition-all flex items-center justify-center gap-2
                      shadow-lg shadow-emerald-100"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                  >
                  ...
                  <motion.button
                    ...
                    className="px-8 py-4 bg-white text-emerald-600 rounded-lg font-semibold 
                      hover:bg-emerald-50 transition-all border border-emerald-200
                      shadow-lg shadow-emerald-100"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                  >
                ...
                {features.map((feature, index) => (
                  <motion.div
                    ...
                    className="bg-white p-6 rounded-lg shadow-md border border-emerald-100 
                      flex items-center gap-4 group cursor-pointer hover:shadow-lg 
                      transition-shadow"
                  >
                    <div className="bg-emerald-50 w-12 h-12 rounded-lg flex items-center 
                      justify-center group-hover:bg-emerald-100 transition-colors">
                      {feature.icon}
                    </div>
                    <div>
            ...
            >
              <p className="text-emerald-600 text-sm mb-2">Discover More</p>
